...
var Histoslider = function (_Component) {
  ...
  function Histoslider(props) {
    _classCallCheck(this, Histoslider);

    var _this = _possibleConstructorReturn(this, (Histoslider.__proto__ || Object.getPrototypeOf(Histoslider)).call(this, props));
    ...
    _this.onChange = function (selection) {
      ...
      var values = selection.map(function (d) {
        return Math.max(extent[0], Math.min(extent[1], +d));
      });
      _this.setState({ selection: values });
      _this.debouncedChange(values);
    };
    ...
    _this.debouncedChange = (0, _lodash.debounce)(_this.props.onChange, 275);
    return _this;
  }
  ...
  _createClass(Histoslider, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.onChange !== this.props.onChange) {
        ...
        this.debouncedChange = (0, _lodash.debounce)(this.props.onChange, 275);
      }
    ...
    value: function render() {
      ...
      var extent = [(0, _d3Array.min)(sortedData, function (_ref5) {
        var x0 = _ref5.x0;
        return +x0;
      }), (0, _d3Array.max)(sortedData, function (_ref6) {
        var x = _ref6.x;
        return +x;
      })];
      var maxValue = (0, _d3Array.max)(sortedData, function (_ref7) {
        var y = _ref7.y;
        return +y;
      });
      ...
      var selection = this.state.selection.length === 2 ? this.state.selection : extent;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Slider2.default, Object.assign({}, this.props, overrides, {
            height: sliderHeight, extent: extent
          }))
        )
      );
    }
...
Histoslider.propTypes = {
  ...
  backgroundColorFunction: _propTypes2.default.func
};
...
Histoslider.defaultProps = {
  ...
  vertical: true,
  backgroundColorFunction: function backgroundColorFunction(v) {
    return v > 5 ? "#0074D9" : 'red';
  }
};
